...
public class PIPUtils {
	public static final int BLUR_STORKE_WIDTH = 20;
	Context c;

	public PIPUtils(Context c) {
		this.c = c;
	}

	@TargetApi(Build.VERSION_CODES.JELLY_BEAN_MR1)
	public Bitmap fastblur(Bitmap bmp, int radius) {
		Bitmap overlay = Bitmap.createBitmap(bmp.getWidth(), bmp.getHeight(),
		...
		if (VERSION.SDK_INT > 17) {
			...
			final ScriptIntrinsicBlur script = ScriptIntrinsicBlur.create(rs,
					Element.U8_4(rs));
			script.setRadius(radius * 2 /* e.g. 3.f */);
